...
public class AnnotationCompletionStrategy extends PHPDocTagStrategy {
	...
	public void apply(final ICompletionReporter reporter) throws BadLocationException {
		...
		IType[] types = getTypes(context, scope, qualifier, name);
		String suffix = "()";
		...
		// handles ORM\ cases for "use Doctrine\ORM\Mapping as ORM;
		// UseStatements
		// AnnotationAliasCompletionStrategy gt = new
		// AnnotationAliasCompletionStrategy(context);
		// gt.apply(reporter);
