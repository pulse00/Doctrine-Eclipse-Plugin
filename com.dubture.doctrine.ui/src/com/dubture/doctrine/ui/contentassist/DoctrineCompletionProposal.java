...
public class DoctrineCompletionProposal extends PHPCompletionProposal {
    ...
    public DoctrineCompletionProposal(CompletionProposal typeProposal, IDocument document, ISourceModule cu, String replacementString, int replacementOffset, int replacementLength,
	...
	if (typeProposal.getModelElement() instanceof AliasType) {
	    replacementString = ((AliasType) typeProposal.getModelElement()).getAlias() + typeProposal.getCompletion().substring(typeProposal.getName().length());
	} else {
