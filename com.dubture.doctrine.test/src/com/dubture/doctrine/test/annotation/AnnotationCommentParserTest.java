package com.dubture.doctrine.test.annotation;
...
"     */";
        ...
        List<Annotation> annotations = parser.parse(comment, 1568).getAnnotations();
...
"     */";
    ...
    protected List<Annotation> getCommentAnnotations(String comment, int commentOffset) {
        ...
        return parser.parse(comment, commentOffset).getAnnotations();
    }
